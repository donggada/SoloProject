...
<tr><th>ID</th><th><%=dd.getName()%></th><th>조회수</th><th><%=dd.getReadcount() %></th></tr>
<tr><th colspan="4">파일 다운로드 <a id="downA" href="#"><%=originalName1%></a></th></tr>
<tr><th colspan="4"><%=dd.getCotent() %></th></tr>
</table> 
...
arr2=cdao.selectcomment(num,1);
for(Object o:arr2){ CommentDTO cdto=(CommentDTO)o;
%>
<hr>
<table>
<tr><td><%=cdto.getId() %></td></tr>
<tr><td><%=cdto.getContent() %></td><td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td><p><%=cdto.getDate() %></p></td></tr>
</table>
